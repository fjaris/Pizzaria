...
public class AdicionalDAO extends BaseDAO implements BaseInterDAO<AdicionalVO> {
	...
	public void remover(AdicionalVO vo) throws SQLException {
		conn = getConnection();
	...
	public void editar(AdicionalVO vo) throws SQLException {
		conn = getConnection();
	...
	public List<AdicionalVO> buscar(AdicionalVO vo) throws SQLException {
		conn = getConnection();
	...
	public List<AdicionalVO> listarPorPizzasEmPedido(PedidoVO voPedido, PizzaVO voPizza) throws SQLException {
		conn = getConnection();
